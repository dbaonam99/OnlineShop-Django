...
function ShopBody(props) {
    ...
    if (dateProductVirtual) {
        ...
        for (let i in dateProductVirtual) {
            ...
            const productDate = new Date(dateProductVirtual[i].created)
    ...
    const chooseSize = (event) => {
        ...
        for (let i in constProduct) {
            for (let j in constProduct[i].size_names) {
                console.log(constProduct[i].size_names[j].toLowerCase())
                if (
                    constProduct[i].size_names[j].toLowerCase() ===
                    id.toLowerCase()
                ) {
    ...
    const choosePrice = () => {
        ...
        for (let i in constProduct) {
            if (
                constProduct[i].finalPrice >= sortPriceValue[0] &&
                constProduct[i].finalPrice <= sortPriceValue[1]
            ) {
                virtualProduct.push(constProduct[i])
            }
        }
    ...
    const filterMobile = () => {
        ...
        if (cateFilter !== '') {
            for (let i in constProduct) {
                if (constProduct[i].category_name === cateFilter) {
                    virtualProduct.push(constProduct[i])
                }
            }
        }
        ...
        if (sizeFilter !== '') {
            for (let i in virtualProduct) {
                if (virtualProduct[i].size === sizeFilter) {
        ...
        for (let i in virtualProduct2) {
            if (
                virtualProduct2[i].finalPrice >= sortPriceValue[0] &&
                virtualProduct2[i].finalPrice <= sortPriceValue[1]
            ) {
            ...
            <div className="shopbody-container">
                <div className="shopbody-filter">
                    <div className="shopbody-filter-cate">
                        <div className="shopbody-filter-title">
                            Product Categories
                        </div>
